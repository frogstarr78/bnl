...
This is an attempt to objectify some natural language. I don't plan on making it a full language parser in any respect. 
But it occurs to me that a small set of natural language (as Jay Fields points out) can be used to implement programming.
